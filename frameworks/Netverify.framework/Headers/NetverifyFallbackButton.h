...
/**
 * UIButton that implements NetverifyAppearance protocol that is used within our help views where users can fallback to another scan view.
 * Please check out our Surface Tool https://jumio.github.io/surface-ios/ to see what customization options are supported.
 **/
__attribute__((visibility("default"))) @interface NetverifyFallbackButton : UIButton <NetverifyAppearance>
