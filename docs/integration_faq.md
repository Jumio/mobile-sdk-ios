...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| ID Verification + Authentication | 23.13 MB | x | x | x | x |  |  |  |
| ID Verification + NFC | 12.85 MB | x | x | x |  |  |  | x |
| Fastfill | 10.22 MB | x | x | x |  |  |  |  |
| Fastfill without Barcode | 7.21 MB | x | x |  |  |  |  |  |
| Document Verification | 1.58 MB | x |  |  |  | x |  |  |
| BAM Checkout credit card scanning | 6.36 MB | x |  |  |  |  | x |  |
| All Products | 31.17 MB | x | x | x | x | x | x | x |
...
## Glossary
A [quick guide to commonly used abbreviations](docs/integration_glossary.md) throughout the documentation which may not be all that familiar.
