...
![Fix](https://img.shields.io/badge/Fix-success) Readded CFBundleShortVersionString to JumioLivenessClient.xcframework
...
![Improvement](https://img.shields.io/badge/Improvement-green) Added support for the Selfie.Done workflow
