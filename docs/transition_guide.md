...
Read more detailed information on this in chapter [Error codes](integration_guide.md#error-codes)
...
Please see [3D-Liveness in Custom Scan View Delegate](integration_guide.md#custom-scan-view-delegate)
...
Read more detailed information on this in [Retrieving information](integration_guide.md#retrieving-information)
